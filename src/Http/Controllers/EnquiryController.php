...
use AnywhereMedia\PageEditor\Form;
use AnywhereMedia\PageEditor\Enquiry;
use AnywhereMedia\PageEditor\Mail\Enquiry as EnquiryMailable;
...
class EnquiryController extends VoyagerBaseController
{
    ...
    public function submit(Request $request)
    {
        ...
        $formDataAndFilesKeys = $this->getFormDataAndFilesKeys($request);
        ...
        // $form->mailto = 'lucasheer@gmail.com';

        // // The from address
        // $form->mailfrom = 'info@anywheremediacompany.com';
        ...
        // Send the email
        Mail::to(array_map('trim', explode(',', 'lucasheer@gmail.com')))
            ->send(new EnquiryMailable('info@AnywhereMediacompany.com', 'anywhere media', 'Test', $formData, $filesKeys));

        return redirect()
            ->back()
            ->with('success', 'Successfully submitted response.');
    }
     ...
     */
    protected function getFormDataAndFilesKeys($request)
    {
